...
| MySQL `mysql-test` statements lexing | 3,869 / 3,869, over a curated 8 files | the corpus, as it grows |
| MySQL `mysql-test` statements parsing | 0 / 3,869 — M3.3–M3.6 | 100% of the curated corpus |
