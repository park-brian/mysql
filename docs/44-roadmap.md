...
| Core bundle, gzipped | 44.8 KB (`@myjs/protocol` 40.2 KB, `@myjs/charsets` 13.9 KB), plus 48.6 KB of UCA weights in a chunk nothing loads until a `_0900_` collation is asked for | < 500 KB |
