...
| **M3** | [Parse SQL](#m3--parse-sql) | lexer, parser, AST | 6 / 11 | ◐ |
...
|---|---|---|
| MySQL `mysql-test` files passing | 0 / 2,448 — needs an executor (M5.15) | ≥ 800 |
| MySQL `mysql-test` statements lexing | 3,868 / 3,868, over a curated 8 files | the corpus, as it grows |
| MySQL `mysql-test` statements parsing | 0 / 3,868 — M3.3–M3.6 | 100% of the curated corpus |
